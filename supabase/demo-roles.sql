...
begin
  ...
  insert into public.profiles (id, role, owner_application_status) values (v_admin, 'admin', null), (v_owner, 'owner', 'active')
  on conflict (id) do update set role = excluded.role, owner_application_status = 'active';
end $$;
