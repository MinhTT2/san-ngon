...
export function SlotCell({
  ...
  const base = 'flex w-full items-center justify-center rounded-slot border text-xs font-semibold tabular-nums transition-colors focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-pitch disabled:cursor-default';
